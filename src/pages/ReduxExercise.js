...
import { addToCart, removeFromCart } from "../service/cart/slice";
...
const ProductOne = (props) => {
  ...
  const removeProduct = () => dispatch(removeFromCart(product));
...
const Store = (props) => {
  ...
  // pass {cart, products} to the src attribute of the component <ReactJson/>
